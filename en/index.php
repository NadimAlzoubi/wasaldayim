...
<head>
    ...
    <!-- Canonical -->
    <link rel="canonical" href="https://wasaldayim.com/en/">
    ...
    <meta name="geo.placename" content="Ghuwaifat Border, Abu Dhabi">
    ...
    <meta property="og:url" content="https://wasaldayim.com/en/">
...
<body>
    ...
    <div class="offcanvas-sidebar tw-p-8 bg-white position-fixed top-0 end-0 tw-max-h-screen tw-z-999 max-w-400-px w-100 tw-translate-x-full overflow-y-auto">
        ...
        <div dir="ltr" class="d-flex flex-column tw-gap-8 overflow-hidden">
            ...
            <div>
                ...
                <div class="d-flex flex-column tw-gap-6">
                    <div class="cursor-small animate-item d-flex align-items-center tw-gap-5">
                        ...
                        <a href="tel:<?php echo $phone_landline; ?>" class="text-main-two-600 hover-text-main-600 hover--translate-x-1 fw-medium tw-text-md rounded"> Landline <bdi><?php echo $phone_landline ?></bdi></a>
                    </div>
                    <div class="cursor-small animate-item d-flex align-items-center tw-gap-5">
                        <span class="tw-w-10 tw-h-10 flex-shrink-0 bg-main-600 rounded-circle text-white tw-text-xl d-flex justify-content-center align-items-center">
                            <i class="ph ph-phone"></i>
                        </span>
                        <a href="tel:<?php echo $phone_mobile; ?>" class="text-main-two-600 hover-text-main-600 hover--translate-x-1 fw-medium tw-text-md rounded"> Mobile <bdi><?php echo $phone_mobile ?></bdi></a>
                    </div>
                    <div class="cursor-small animate-item d-flex align-items-center tw-gap-5">
                        <span class="tw-w-10 tw-h-10 flex-shrink-0 bg-main-600 rounded-circle text-white tw-text-xl d-flex justify-content-center align-items-center">
                            <i class="ph ph-phone"></i>
                        </span>
                        <a href="tel:<?php echo $phone_manager; ?>" class="text-main-two-600 hover-text-main-600 hover--translate-x-1 fw-medium tw-text-md rounded"> Manager <bdi><?php echo $phone_manager ?></bdi></a>
                    </div>
                    <div class="cursor-small animate-item d-flex align-items-center tw-gap-5">
                        <span class="tw-w-10 tw-h-10 flex-shrink-0 bg-main-600 rounded-circle text-white tw-text-xl d-flex justify-content-center align-items-center">
                        ...
                        <div class="header-menu d-lg-block d-none ps-108-px">
                            ...
                            <ul class="nav-menu cursor-small d-lg-flex align-items-center xl-tw-gap-12 tw-gap-4">
                                ...
                                <li class="nav-menu__item has-submenu position-relative">
                                    <a href="javascript:void(0)" class="nav-menu__link hover--translate-y-1 text-main-two-600 tw-py-9 fw-medium w-100 tw-pe-4">Contact numbers</a>
                                    <ul class="nav-submenu scroll-sm position-absolute start-0 top-100 tw-w-max bg-white tw-rounded-md overflow-hidden tw-p-2 tw-mt-4 tw-duration-200 tw-z-99">
                                        <li class="nav-menu__item">
                                            <a href="tel:<?php echo $phone_landline ?>" class="nav-submenu__link hover-bg-neutral-100 text-black fw-medium w-100 d-block tw-py-2 tw-px-305 tw-rounded"> Landline <?php echo $phone_landline ?></a>
                                        </li>
                                        <li class="nav-submenu__item d-block tw-rounded tw-duration-200 position-relative">
                                            <a href="tel:<?php echo $phone_mobile ?>" class="nav-submenu__link hover-bg-neutral-100 text-black fw-medium w-100 d-block tw-py-2 tw-px-305 tw-rounded"> Mobile <?php echo $phone_mobile ?></a>
                                        </li>
                                        <li class="nav-submenu__item d-block tw-rounded tw-duration-200 position-relative">
                                            <a href="tel:<?php echo $phone_manager ?>" class="nav-submenu__link hover-bg-neutral-100 text-black fw-medium w-100 d-block tw-py-2 tw-px-305 tw-rounded"> Manager <?php echo $phone_manager ?></a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <div class="d-flex align-items-center tw-gap-36-px flex-shrink-0">
                            ...
                            <div class="cursor-small position-relative group-item hover-mt-0">
                                <div class="d-flex align-items-center tw-gap-2">
                                    <a href="../ar" class="selected-text text-white d-flex align-items-center gap-2 responsive-text">
                                        <span class="tw-w-25-px tw-h-25-px border border-white border-2 rounded-circle common-shadow d-flex justify-content-center align-items-center">
                                            <img src="../assets/images/thumbs/flag7.png" alt="" class="w-100 h-100 object-fit-cover rounded-circle">
                                        </span>
                                        عربي
                                    </a>
                                </div>
        ...
        <div class="container" id="home">
            <div class="row gy-4 justify-content-end">
                <div class="col-lg-7 position-relative z-2">
                    ...
                    <h1 class="splitTextStyleOne cursor-big text-white tw-text-22-px text-ltr" style="line-height: 2;">“ <?php echo $hero_headline ?> ”</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row gy-4">
                <div class="col-lg-7 pe-lg-5">
                    <div class="">
                        ...
                        <div dir="ltr" class="testimonials-three-content-slider swiper">
    ...
    <div class="brand-three-slider-wrapper tw-mt-13">
        ...
        <div class="position-relative z-1">
            ...
            <section dir="ltr" class="service-three tw-py-10 overflow-hidden" id="services">
                <div class="container">
                    <div class="max-w-856-px mx-auto text-center tw-pb-6 tw-mb-6">
                        ...
                        <h1 class="splitTextStyleOne cursor-big" dir="ltr">
                ...
                <div class="container">
                    <div class="max-w-856-px mx-auto text-center tw-pb-16">
                        ...
                        <h2 class="cursor-big h1">
                            <span class="splitTextStyleOne" dir="ltr"><?php echo $borders_we_serve ?></span>
                        </h2>
                    </div>
            ...
            <section class="pt-140 pb-120">
                <div class="container" id="why-us">
                    <div class="row gy-4">
                        <div class="col-lg-5" style="margin-bottom: 4rem;">
                            <div class="tw-pe-9 tw-pb-6 tw-ps-5 position-relative h-100 tw-min-h-500-px">
                                ...
                                <div class="bg-main-two-600 tw-rounded-xl tw-py-105 position-absolute tw-end-0 top-50 tw--translate-y-50">
                                    <div class="bg-main-600 tw-rounded-xl tw-px-7 tw-py-11">
                                        <h5 dir="ltr" class="writing-mode text-center font-carter text-white fw-normal cursor-big splitTextStyleOne"><span class="fw-bolder"><?php echo $hero_company ?></span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7 ps-lg-5" dir="ltr">
                            <div class="">
                                <span class="splitTextStyleTwo cursor-small tw-text-xl fw-bold text-main-600 tw-mb-305 w-100 text-center"><?php echo $hero_company ?></span>
        ...
        <div class="position-relative z-1 overflow-hidden" dir="ltr">
            <div class="container">
                <div class="max-w-856-px mx-auto text-center pt-120 tw-mb-6">
                    <span class="splitTextStyleTwo cursor-small tw-text-xl fw-bold text-main-600 tw-mb-305 w-100 text-center"><?php echo $hero_company ?></span>
                    <h1 class="splitTextStyleOne cursor-big" dir="ltr">
                        <?php echo "Request a quote" ?>
                    </h1>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <p class="tw-text-sm tw-text-gray-500 tw-mb-6">
                                        Please fill in the following details and our team will contact you and provide you with the best quote shortly.
                                    </p>
                                    <!-- Customer Info -->
        ...
        <!-- =============================== Footer start ============================== -->
        <footer dir="ltr" class="footer bg-main-two-600 position-relative z-1 mt-auto tw-pt-14">
            <div class="container">
                ...
                <div class="border-top border-dashed border-neutral-1100 tw-py-8">
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="text-center tw-text-xs text-neutral-400 tw-mt-2 tw-pb-2">
                            Developed by <a href="https://nadim.pro" target="_blank" class="hover-text-main-600">Nadim Alzoubi</a>
                        </div>
